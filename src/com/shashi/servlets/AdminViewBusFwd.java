...
public class AdminViewBusFwd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (trains != null && !trains.isEmpty()) {
				...
				rd.include(req, res);
				pw.println("<div class='main'><p1 class='menu'>Running Buses</p1></div>");
				pw.println("<div class='tab'><table><tr><th>Bus Name</th><th>Bus Number</th>"
						+ "<th>From Depot</th><th>To Depot</th><th>Seats Available</th><th>Fare (LKR)</th><th>Action</th></tr>");
