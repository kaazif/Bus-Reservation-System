...
public class BusBwStn extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (trains != null && !trains.isEmpty()) {
				...
				rd.include(req, res);
				pw.println("<div class='main'><p1 class='menu'>Bus BetWeen Station "
						+ req.getParameter("fromstation") + " and " + req.getParameter("tostation") + "</p1></div>");
				pw.println("<div class='tab'><table><tr><th>Bus Name</th><th>Bus No</th>"
						+ "<th>From Depot</th><th>To Depot</th><th>Time</th><th>Seats</th><th>Fare (LKR)</th><th>Action</th></tr>");
				...
				rd.include(req, res);
				pw.println("<div class='tab'><p1 class='menu'>There are no Buses Between "
						+ req.getParameter("fromstation") + " and " + req.getParameter("tostation") + "</p1></div>");
			}
		} catch (Exception e) {
