	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (trains != null && !trains.isEmpty()) {
				...
				rd.include(req, res);
				pw.println("<div class='main'><p1 class='menu'>Fare for Bus BetWeen Station " + fromStation + " and "
				...
				rd.include(req, res);
				pw.println("<div class='tab'><p1 class='menu'>There are no Buses Between " + fromStation + " and "
						+ toStation + "</p1></div>");
			}
		} catch (Exception e) {
