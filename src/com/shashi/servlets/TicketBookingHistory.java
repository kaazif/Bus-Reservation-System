	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (details != null && !details.isEmpty()) {
				...
				pw.println("<div class='tab'><table><tr><th>Transaction ID</th><th>Bus Number</th>"
						+ "<th>From Depot</th><th>To Depot</th><th>Journey Date</th><th>Seat</th><th>Amount Paid</th></tr>");
