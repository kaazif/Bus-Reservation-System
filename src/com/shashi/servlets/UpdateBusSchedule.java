...
public class UpdateBusSchedule extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if ("SUCCESS".equalsIgnoreCase(message)) {
				...
				rd.include(req, res);
				pw.println("<div class='tab'><p1 class='menu'>Bus Updated Successfully!</p1></div>");
			} else {
				RequestDispatcher rd = req.getRequestDispatcher("AdminUpdateTrain.html");
				rd.include(req, res);
				pw.println("<div class='tab'><p1 class='menu'>Error in filling the Bus Detail</p1></div>");
			}
		} catch (Exception e) {
