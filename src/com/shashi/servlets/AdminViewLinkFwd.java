	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (train != null) {
				...
				rd.include(req, res);
				pw.println("<div class='main'><p1 class='menu'>Selected Bus Detail</p1></div>");
				pw.println("<div class='tab'>" + "<table>" + "<tr><td class='blue'>Bus Name :</td><td>"
						+ train.getTr_name() + "</td></tr>" + "<tr><td class='blue'>Bus Number :</td><td>"
						+ train.getTr_no() + "</td></tr>" + "<tr><td class='blue'>From Bus Depot :</td><td>"
						+ train.getFrom_stn() + "</td></tr>" + "<tr><td class='blue'>To Bus Depot :</td><td>"
