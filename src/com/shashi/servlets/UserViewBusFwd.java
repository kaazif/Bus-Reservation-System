...
public class UserViewBusFwd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (trains != null && !trains.isEmpty()) {
				...
				rd.include(req, res);
				pw.println("<div class='main'><p1 class='menu'>Running Bus</p1></div>");
				pw.println("<div class='tab'><table><tr><th>Bus Name</th><th>Bus Number</th>"
						+ "<th>From Depot</th><th>To Depot</th><th>Time</th><th>Seats Available</th><th>Fare (LKR)</th><th>Booking</th></tr>");
				...
				RequestDispatcher rd = req.getRequestDispatcher("UserViewTrains.html");
				rd.include(req, res);
				pw.println("<div class='main'><p1 class='menu red'> No Running Buses</p1></div>");
			}
		} catch (Exception e) {
